...
作者：张贵发
日期：2023年06月12日
描述：后续支持网络爬虫，爬取后直接生成视频，下面是生成数据的小例子
"""

import pandas as pd
def create_data_example():
    # 创建数据框
    df = pd.DataFrame(columns=['id', 'story_framwork', 'content', 'len_text', 'type', 'en_name', 'cn_name', 'status'])
    ...
    content ="陈雨疲惫地拍了拍自己的脑门，又拿起一本古籍开始研究，他的目光专注而坚定。这位专家对于古籍的兴趣和热情一直都是无人能及的，而这次他遇到了一本特别的古籍——《死者之书》。《死者之书》记录了一系列让人毛骨悚然的谋杀案，这些案件都匪夷所思，让陈雨不得不重新审视过去的这些案件。他的研究引起了警方的注意，但他并没有放弃，反而更加坚定地要解开这个谜团。陈雨的调查逐渐深入，他发现这些案件都隐藏着一个久远的秘密。随着调查的深入，他意识到自己已经卷入了一个更加危险的局面中。一天晚上，陈雨突然接到了一个神秘的电话，对方声称自己知道《死者之书》的真相，并邀请他前往一个偏远的村庄。陈雨迫不及待地赶往村庄，却发现那里已经是一片废墟，而对方也不见了踪影。陈雨惊恐万分，但他没有放弃，他相信这一切都与古籍有关。他回到了他的实验室，开始重新审视这本神秘的古籍。在一番研究之后，他发现这些案件都与古时王朝的仇杀有关，而这些仇杀正是某个家族所为。陈雨决定阻止这个家族的复仇计划，他开始寻找这个家族的线索，最终找到了目标。在一次危险的行动中，他成功阻止了复仇计划，并将罪犯绳之以法。陈雨的勇气和智慧最终解开了《死者之书》的谜团，他的贡献得到了社会的认可和赞誉。他知道，他的研究不仅仅是为了解开这个谜团，更是为了保护社会的安宁和公正。"
    # 插入一行数据
    new_row = {'id': 1, 'story_framwork': story_framework, 'content': content, 'len_text': 4000, 'type': '玄幻类', 'en_name': 'story_1', 'cn_name': '死亡之书', 'status': '未完成'}
